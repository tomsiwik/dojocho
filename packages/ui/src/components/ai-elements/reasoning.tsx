  ...
  ({
    ...
    return (
      ...
      >
        {children ?? (
          <>
            {isStreaming ? <BrainIcon className="size-4" /> : null}
...
export const ReasoningContent = memo(
  ({ className, children, ...props }: ReasoningContentProps) => (
    <CollapsibleContent
      className={cn(
        "mt-4 text-sm",
        "data-[state=closed]:hidden data-[state=open]:slide-in-from-top-2 text-muted-foreground outline-none data-[state=open]:animate-in",
        className
      )}
      {...props}
    >

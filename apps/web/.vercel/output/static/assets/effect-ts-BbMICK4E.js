import{a as e}from"./chunk-BNv3lrIs.js";import{Tt as t}from"./index-BPR-Qz1M.js";var n=e(t()),r={title:`Effect-TS`,description:`Master Effect-TS through 40 hands-on katas, from Effect.succeed to managed runtimes.`},i=`
...
> * Point to type signatures or API names
> * Narrow scope: "Focus on the first failing test"
> * Never write or show solution code`},{heading:`teaching-contract`,content:"That contract is enforced kata-by-kata via per-kata `SENSEI.md` files, which\nalso flag which APIs belong to *you* (the student) versus the test harness\n(`runSync`, `runSyncExit`) — a small but important detail Effect-TS beginners\noften get backwards."},{heading:`requirements`,content:`Node.js 20+`},{heading:`requirements`,content:"A package manager that supports workspaces — `pnpm` is recommended."},{heading:`requirements`,content:"The `effect` runtime is installed as a dependency of the dojo; the test\nrunner is Vitest."},{heading:`source`,content:`The dojo source lives in the Dojocho monorepo.`}],headings:[{id:`install`,content:`Install`},{id:`what-youll-learn`,content:`What you'll learn`},{id:`teaching-contract`,content:`Teaching contract`},{id:`requirements`,content:`Requirements`},{id:`source`,content:`Source`}]},o=[{depth:2,url:`#install`,title:(0,n.jsx)(n.Fragment,{children:`Install`})},{depth:2,url:`#what-youll-learn`,title:(0,n.jsx)(n.Fragment,{children:`What you'll learn`})},{depth:2,url:`#teaching-contract`,title:(0,n.jsx)(n.Fragment,{children:`Teaching contract`})},{depth:2,url:`#requirements`,title:(0,n.jsx)(n.Fragment,{children:`Requirements`})},{depth:2,url:`#source`,title:(0,n.jsx)(n.Fragment,{children:`Source`})}];function s(e){let t={a:`a`,blockquote:`blockquote`,code:`code`,em:`em`,h2:`h2`,li:`li`,p:`p`,pre:`pre`,span:`span`,strong:`strong`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsxs)(t.p,{children:[`The `,(0,n.jsx)(t.strong,{children:(0,n.jsx)(t.code,{children:`@dojocho/effect-ts`})}),` dojo is a 40-kata curriculum for
`,(0,n.jsx)(t.a,{href:`https://effect.website`,children:`Effect-TS`}),`. You build up from the smallest unit
(`,(0,n.jsx)(t.code,{children:`Effect.succeed`}),`) all the way to layered services, fibers, streams, and a
managed runtime — one failing test at a time.`]}),`
...
`,(0,n.jsxs)(t.span,{className:`line`,children:[(0,n.jsx)(t.span,{style:{"--shiki-light":`#6F42C1`,"--shiki-dark":`#B392F0`},children:`dojo`}),(0,n.jsx)(t.span,{style:{"--shiki-light":`#032F62`,"--shiki-dark":`#9ECBFF`},children:` add`}),(0,n.jsx)(t.span,{style:{"--shiki-light":`#032F62`,"--shiki-dark":`#9ECBFF`},children:` effect-ts`})]})]})})}),`
...
`,(0,n.jsx)(t.p,{children:`The dojo is organised into areas. Each area starts with a skill the sensei
loads before the first kata, then walks through the APIs hands-on:`}),`
`,(0,n.jsxs)(t.table,{children:[(0,n.jsx)(t.thead,{children:(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.th,{children:`Area`}),(0,n.jsx)(t.th,{children:`Katas`}),(0,n.jsx)(t.th,{children:`Topics`})]})}),(0,n.jsxs)(t.tbody,{children:[(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:(0,n.jsx)(t.strong,{children:`Foundations`})}),(0,n.jsx)(t.td,{children:`001 – 005`}),(0,n.jsxs)(t.td,{children:[(0,n.jsx)(t.code,{children:`Effect.succeed`}),`, `,(0,n.jsx)(t.code,{children:`map`}),`, generators, `,(0,n.jsx)(t.code,{children:`flatMap`}),`, `,(0,n.jsx)(t.code,{children:`pipe`}),` composition`]})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:(0,n.jsx)(t.strong,{children:`Errors`})}),(0,n.jsx)(t.td,{children:`006 – 008`}),(0,n.jsxs)(t.td,{children:[(0,n.jsx)(t.code,{children:`Effect.fail`}),`, tagged errors, error channels, recovery patterns`]})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:(0,n.jsx)(t.strong,{children:`Modelling`})}),(0,n.jsx)(t.td,{children:`009 – 010`}),(0,n.jsxs)(t.td,{children:[(0,n.jsx)(t.code,{children:`Option`}),`, `,(0,n.jsx)(t.code,{children:`Either`}),`, `,(0,n.jsx)(t.code,{children:`Exit`})]})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:(0,n.jsx)(t.strong,{children:`Services & Layers`})}),(0,n.jsx)(t.td,{children:`011 – 013`}),(0,n.jsxs)(t.td,{children:[(0,n.jsx)(t.code,{children:`Context.Tag`}),`, `,(0,n.jsx)(t.code,{children:`Layer`}),`, testing with mocks`]})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:(0,n.jsx)(t.strong,{children:`Schema`})}),(0,n.jsx)(t.td,{children:`014 – 015`}),(0,n.jsxs)(t.td,{children:[(0,n.jsx)(t.code,{children:`Schema.Struct`}),`, refinements, domain modelling`]})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:(0,n.jsx)(t.strong,{children:`Concurrency`})}),(0,n.jsx)(t.td,{children:`016 – 020`}),(0,n.jsxs)(t.td,{children:[(0,n.jsx)(t.code,{children:`retry`}),`, schedules, parallelism, `,(0,n.jsx)(t.code,{children:`race`}),`, `,(0,n.jsx)(t.code,{children:`Ref`}),`, fibers`]})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:(0,n.jsx)(t.strong,{children:`Resources`})}),(0,n.jsx)(t.td,{children:`021 – 023`}),(0,n.jsxs)(t.td,{children:[(0,n.jsx)(t.code,{children:`acquireRelease`}),`, scoped layers, resource patterns`]})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:(0,n.jsx)(t.strong,{children:`Streams`})}),(0,n.jsx)(t.td,{children:`024 – 027`}),(0,n.jsxs)(t.td,{children:[(0,n.jsx)(t.code,{children:`Stream`}),` basics, operations, combinators, data pipelines`]})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:(0,n.jsx)(t.strong,{children:`Observability`})}),(0,n.jsx)(t.td,{children:`028`}),(0,n.jsx)(t.td,{children:`logging, spans`})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:(0,n.jsx)(t.strong,{children:`HTTP`})}),(0,n.jsx)(t.td,{children:`029`}),(0,n.jsx)(t.td,{children:`typed HTTP client`})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:(0,n.jsx)(t.strong,{children:`Capstone`})}),(0,n.jsx)(t.td,{children:`030`}),(0,n.jsx)(t.td,{children:`end-to-end, all areas combined`})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:(0,n.jsx)(t.strong,{children:`Advanced`})}),(0,n.jsx)(t.td,{children:`031 – 040`}),(0,n.jsx)(t.td,{children:`config, causes, pattern matching, queues, metrics, managed runtime, request batching`})]})]})]}),`
`,(0,n.jsxs)(t.p,{children:[`Each kata is a single failing Vitest test. Your sensei reads the test and the
`,(0,n.jsx)(t.code,{children:`SENSEI.md`}),`, then asks you targeted questions until you make it green.`]}),`
`,(0,n.jsx)(t.h2,{id:`teaching-contract`,children:`Teaching contract`}),`
`,(0,n.jsxs)(t.p,{children:[`Quoting the dojo's own `,(0,n.jsx)(t.code,{children:`DOJO.md`}),`:`]}),`
...
`,(0,n.jsx)(t.li,{children:`Point to type signatures or API names`}),`
...
`]}),`
`]}),`
`,(0,n.jsxs)(t.p,{children:[`That contract is enforced kata-by-kata via per-kata `,(0,n.jsx)(t.code,{children:`SENSEI.md`}),` files, which
also flag which APIs belong to `,(0,n.jsx)(t.em,{children:`you`}),` (the student) versus the test harness
(`,(0,n.jsx)(t.code,{children:`runSync`}),`, `,(0,n.jsx)(t.code,{children:`runSyncExit`}),`) — a small but important detail Effect-TS beginners
often get backwards.`]}),`
`,(0,n.jsx)(t.h2,{id:`requirements`,children:`Requirements`}),`
`,(0,n.jsxs)(t.ul,{children:[`
`,(0,n.jsx)(t.li,{children:`Node.js 20+`}),`
`,(0,n.jsxs)(t.li,{children:[`A package manager that supports workspaces — `,(0,n.jsx)(t.code,{children:`pnpm`}),` is recommended.`]}),`
`,(0,n.jsxs)(t.li,{children:[`The `,(0,n.jsx)(t.code,{children:`effect`}),` runtime is installed as a dependency of the dojo; the test
runner is Vitest.`]}),`
`]}),`
`,(0,n.jsx)(t.h2,{id:`source`,children:`Source`}),`
`,(0,n.jsxs)(t.p,{children:[`The dojo source lives in the `,(0,n.jsx)(t.a,{href:`https://github.com/tomsiwik/dojocho/tree/main/dojos/effect-ts`,children:`Dojocho monorepo`}),`.`]})]})}function c(e={}){let{wrapper:t}=e.components||{};return t?(0,n.jsx)(t,{...e,children:(0,n.jsx)(s,{...e})}):s(e)}export{i as _markdown,c as default,r as frontmatter,a as structuredData,o as toc};
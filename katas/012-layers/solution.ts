...
// TODO: Create a Layer that provides Config with baseUrl "https://api.example.com"
export const ConfigLive: Layer.Layer<Config> = Layer.effectDiscard(
  Effect.die("Not implemented"),
) as unknown as Layer.Layer<Config>;

// TODO: Create a Layer that provides Logger with a log function that uses Effect.log
export const LoggerLive: Layer.Layer<Logger> = Layer.effectDiscard(
  Effect.die("Not implemented"),
) as unknown as Layer.Layer<Logger>;

// TODO: Create a program that reads Config.baseUrl and Logger.log to return "{baseUrl}/users"

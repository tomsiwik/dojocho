...
// TODO: Retry the given effect up to 3 times using Schedule.recurs(3)
...
// TODO: Create an effect that fails n times then succeeds with "done".
...
// TODO: Repeat the effect 3 times using Schedule.recurs(3) and collect the results

...
// TODO: Use pipe to: start with Effect.succeed(n), double it, add 1, convert to string
export const processNumber = (n: number): Effect.Effect<string> => {
  throw new Error("Not implemented");
};

// TODO: Use .pipe() fluent style to validate name is non-empty and age >= 0,
...
// TODO: Use pipe to compose: parse string to int (fail with "ParseError"),
